...
predictor.distill(time_limit=time_limit, hyperparameters={'RF': {}}, teacher_preds='soft', augment_method='spunge', augment_args={'size_factor': 1}, verbosity=3, models_name_suffix='spunge')
